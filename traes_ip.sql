...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2017 a las 17:51:14
...
CREATE TABLE `cursos` (
  ...
  `matricula` int(2) DEFAULT NULL,
  `organizacion_cursada` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `centro_id` int(11) NOT NULL,
...
CREATE TABLE `inscripcions` (
  `id` int(11) NOT NULL,
  `legajo_nro` varchar(15) DEFAULT NULL,
  ...
  `recursante` tinyint(1) DEFAULT NULL,
  `nota` int(2) DEFAULT NULL,
  `condicion_aprobacion` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `fecha_nota` date DEFAULT NULL,
  `fotocopia_dni` tinyint(1) DEFAULT NULL,
  `certificado_septimo` tinyint(1) DEFAULT NULL,
  `certificado_laboral` tinyint(1) DEFAULT NULL,
  `observaciones` text,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  `alumno_id` int(11) NOT NULL,
...
CREATE TABLE `notas` (
  `id` int(11) NOT NULL,
  `nota_uno_primer_periodo` decimal(3,2) UNSIGNED DEFAULT NULL,
  `evaluacion_tipo_nota_uno_primer_periodo` varchar(50) DEFAULT NULL,
  `nota_dos_primer_periodo` decimal(3,2) UNSIGNED DEFAULT NULL,
  `evaluacion_tipo_nota_dos_primer_periodo` varchar(50) DEFAULT NULL,
  `nota_tres_primer_periodo` decimal(3,2) UNSIGNED DEFAULT NULL,
